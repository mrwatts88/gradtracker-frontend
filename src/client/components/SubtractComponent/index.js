...
export class SubtractComponent extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div id="subtraction" className="card">
                ...
                <div className="card-body">
                    ...
                    <div>
                        <button className="calc-button" disabled={!val1 || !val2} onClick={() => this.props.executeSubtraction(val1, val2)}>-</button>
                    </div>
                </div>
