...
export const POST_FORM_DEF_CLEAR_ERROR = 'POST_FORM_DEF_CLEAR_ERROR';
...
export const GET_ALL_FORM_DEFS_CLEAR_ERROR = 'GET_ALL_FORM_DEFS_CLEAR_ERROR';
...
export const GET_FORM_DEF_CLEAR_ERROR = 'GET_FORM_DEF_CLEAR_ERROR';
...
export const DELETE_FORM_DEF_CLEAR_ERROR = 'DELETE_FORM_DEF_CLEAR_ERROR';

export function postFormDef(formDef) {
  return async dispatch => {
    try {
      dispatch({ type: POST_FORM_DEF_CLEAR_ERROR });
...
export function deleteFormDef(id) {
  return async dispatch => {
    try {
      dispatch({ type: DELETE_FORM_DEF_CLEAR_ERROR });
...
export function getFormDef(id) {
  return async dispatch => {
    try {
      dispatch({ type: GET_FORM_DEF_CLEAR_ERROR });
...
export function getAllFormDefs() {
  return async dispatch => {
    try {
      dispatch({ type: GET_ALL_FORM_DEFS_CLEAR_ERROR });
