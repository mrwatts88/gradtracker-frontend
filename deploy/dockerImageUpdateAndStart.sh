...
#run docker image
echo "docker run -d -p 4000:4000 --name $CI_PROJECT_NAME registry.uwm-nm-te-capstone.com:8083/$CI_PROJECT_NAME:latest"
docker run -d -p 4000:4000 --name $CI_PROJECT_NAME registry.uwm-nm-te-capstone.com:8083/$CI_PROJECT_NAME:latest